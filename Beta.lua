...
screenGui.Name = "BRUHHH"
screenGui.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")

textButton.Name = "BRUHHH"
textButton.Parent = screenGui
textButton.BackgroundColor3 = Color3.fromRGB(240, 255, 139) 
textButton.Size = UDim2.new(0, 35, 0, 35) 
textButton.AnchorPoint = Vector2.new(0, 0.5) 
textButton.Position = UDim2.new(0, 10, 0.3, 0) 
textButton.Text = "Stop\nTween" 
textButton.TextColor3 = Color3.new(0.019608, 0.015686, 0.015686) 
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
  ...
  Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Fast Atack", Description = "invisible monster for have better fps", Default = true })
    Toggle:OnChanged(function(Value)
local ReplicatedStorage_upvr = game:GetService("ReplicatedStorage")
local CombatUtil_upvr = require(ReplicatedStorage_upvr.Modules.CombatUtil)
hookfunction(CombatUtil_upvr.CanAttack, function()
    return false
end)
...
function BringMobBone(name, CFrameMon)
    ...
    Title = "Speed Tween",
    Values = {"300", "340", "350", "500", "700", "10000"},
    Multi = false,
    Default = 340,
})
